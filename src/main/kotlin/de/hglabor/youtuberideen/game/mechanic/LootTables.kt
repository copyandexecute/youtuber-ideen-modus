...
object LootTables {
    ...
    val normal = setOf(
        ...
        LootItem(ItemStack(Material.OAK_PLANKS), maxAmount = 64, probability = 80),
        LootItem(ItemStack(Material.COBBLESTONE), maxAmount = 64, probability = 80),
        LootItem(ItemStack(Material.STONE), maxAmount = 64, probability = 80),
